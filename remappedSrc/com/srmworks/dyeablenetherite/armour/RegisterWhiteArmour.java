...
public class RegisterWhiteArmour {
    ...
    public static void register() {
        Registry.register(Registry.ITEM, id("white_netherite_helmet"), WHITE_NETHERITE_HELMET);
        Registry.register(Registry.ITEM, id("white_netherite_chestplate"), WHITE_NETHERITE_CHESTPLATE);
        Registry.register(Registry.ITEM, id("white_netherite_leggings"), WHITE_NETHERITE_LEGGINGS);
        Registry.register(Registry.ITEM, id("white_netherite_boots"), WHITE_NETHERITE_BOOTS);
    }
}
