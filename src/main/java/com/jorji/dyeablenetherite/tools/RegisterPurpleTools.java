...
public class RegisterPurpleTools {
    ...
    public static final ToolItem PURPLE_NETHERITE_PICKAXE = new PickaxeType(UniversalToolMaterial.INSTANCE, 5, -2.8F, UniversalToolMaterial.UNIVERSAL_TOOL_SETTINGS);
    public static final ToolItem PURPLE_NETHERITE_AXE = new AxeType(UniversalToolMaterial.INSTANCE, 9, -3F, UniversalToolMaterial.UNIVERSAL_TOOL_SETTINGS);
    public static final ToolItem PURPLE_NETHERITE_SHOVEL = new ShovelType(UniversalToolMaterial.INSTANCE, 5.5F, -3F, UniversalToolMaterial.UNIVERSAL_TOOL_SETTINGS);
    public static final ToolItem PURPLE_NETHERITE_SWORD = new SwordType(UniversalToolMaterial.INSTANCE, 7, -2.4F, UniversalToolMaterial.UNIVERSAL_TOOL_SETTINGS);
    public static final ToolItem PURPLE_NETHERITE_HOE = new SwordType(UniversalToolMaterial.INSTANCE, 0, 0F, UniversalToolMaterial.UNIVERSAL_TOOL_SETTINGS);
